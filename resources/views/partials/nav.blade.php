                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li {{ Request::is('start', 'start/') ? 'class=active' : null }}>{!! HTML::link(url('/start'), 'Start') !!}</li>
                            <li {{ Request::is('overview', 'overview/') ? 'class=active' : null }}>{!! HTML::link(url('/overview'), 'Overview') !!}</li>
                            <li {{ Request::is('participant', 'participant/') ? 'class=active' : null }}>{!! HTML::link(url('/participant'), 'Participant List') !!}</li>
                        </ul>
                </li>
                @endif
